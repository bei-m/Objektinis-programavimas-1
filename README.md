...
4. Vartotojui duodamas pasirinkimas namų darbų pažymius įvedinėti pačiam (paspaudus 'i') arba pasirinkti, kad programa pažymius generuotų atsitiktinai (paspaudus 'g').
   ...
   * Pasirinkus generuoti pažymius ('g'), vartotojas įveda norimą pažymių kiekį (sugeneruoti). Jei programos pradžioje buvo nustatytas maksimalus pažymių kiekis, o norimų generuoti pažymių kiekis yra mažesnis už maksimalų, pasirinktas kiekis bus sugeneruotas, o likęs kiekis bus užpildytas nuliais.
