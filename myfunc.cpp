...
{   
    ...
    auto start = high_resolution_clock::now();
        ...
        else if (ch==1) 
        {
            ...
            ofstream rez1("protingieji(v).txt");
...
void testl(string f)
{
    ...
    auto start = high_resolution_clock::now();
        ...
        grupe.clear();
        auto s4 = high_resolution_clock::now();
        ofstream rez1("protingieji(l).txt");
        rez1<<setw(20)<<left<<"Pavarde"<<setw(16)<<left<<"Vardas";
        rez1<<setw(16)<<left<<"Galutinis(Vid.)"<<setw(16)<<left<<"Galutinis(Med.)"<<endl;
        for (auto &j:grupe_2)
        {
...
{   
    ...
    auto start = high_resolution_clock::now();
        ...
        grupe.clear();
        auto s4 = high_resolution_clock::now();
        ofstream rez1("protingieji(d).txt");
        rez1<<setw(20)<<left<<"Pavarde"<<setw(16)<<left<<"Vardas";
        rez1<<setw(16)<<left<<"Galutinis(Vid.)"<<setw(16)<<left<<"Galutinis(Med.)"<<endl;
        for (auto &j:grupe_2)
        {
